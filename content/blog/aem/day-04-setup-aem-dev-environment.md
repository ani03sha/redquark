...
3. Next screen will show you the installed plugins. Type "AEM" in the search bar. You will see two plugins ```AEM IDE Tooling 4 IntelliJ``` and ```AEM IntelliJ Plugin```. Install both and restart IDE.
